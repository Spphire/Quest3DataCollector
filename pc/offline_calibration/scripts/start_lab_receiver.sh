...
FORMAL_CONTROL_MODE="${QUEST3_FORMAL_CONTROL_MODE:-controller_teleop}"
CARTESIAN_MAX_LINEAR_VELOCITY="${QUEST3_CARTESIAN_MAX_LINEAR_VELOCITY_MPS:-1.0}"
CARTESIAN_MAX_ANGULAR_VELOCITY="${QUEST3_CARTESIAN_MAX_ANGULAR_VELOCITY_RADPS:-1.0}"
CARTESIAN_MAX_LINEAR_ACCELERATION="${QUEST3_CARTESIAN_MAX_LINEAR_ACCELERATION_MPS2:-2.0}"
CARTESIAN_MAX_ANGULAR_ACCELERATION="${QUEST3_CARTESIAN_MAX_ANGULAR_ACCELERATION_RADPS2:-2.0}"
...
ENABLE_GRIPPER="${QUEST3_ENABLE_GRIPPER:-1}"
...
Environment overrides:
  ...
  QUEST3_CARTESIAN_MAX_LINEAR_VELOCITY_MPS
  QUEST3_CARTESIAN_MAX_ANGULAR_VELOCITY_RADPS
  QUEST3_CARTESIAN_MAX_LINEAR_ACCELERATION_MPS2
  QUEST3_CARTESIAN_MAX_ANGULAR_ACCELERATION_RADPS2
...
cmd=(
  ...
  --cartesian-max-linear-velocity "$CARTESIAN_MAX_LINEAR_VELOCITY"
  --cartesian-max-angular-velocity "$CARTESIAN_MAX_ANGULAR_VELOCITY"
  --cartesian-max-linear-acceleration "$CARTESIAN_MAX_LINEAR_ACCELERATION"
  --cartesian-max-angular-acceleration "$CARTESIAN_MAX_ANGULAR_ACCELERATION"
